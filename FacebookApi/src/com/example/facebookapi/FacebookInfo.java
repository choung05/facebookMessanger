...
public class FacebookInfo {
	private              String TAG      = "FBFunctions";
	...
	public void createNotification(String pName, String pMessage, int pUserId, int num){
		...
		notification = new Notification(R.drawable.ic_notification, "new incoming message", System.currentTimeMillis());
	...
	public MessageListener globalMessageListener = new MessageListener() {
		...
		public void processMessage(Chat arg0, Message message) {
			if (message.getBody() != null) {
				...
				//final int position = who(message.getFrom());
